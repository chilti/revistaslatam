...
# Load country metrics for full period (Legacy doesn't isolate 2021-2025)
country_file = CACHE_DIR / 'metrics_country_period.parquet'
...
# Load journal metrics for full period (Legacy doesn't isolate 2021-2025)
journal_file = CACHE_DIR / 'metrics_journal_period.parquet'
